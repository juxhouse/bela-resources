...
It is called by build pipelines or repository actions (Github actions, for example) every time new commits are pushed or merged to the main branch (see [CodeSynchronization](/CodeSynchronization.md)).
